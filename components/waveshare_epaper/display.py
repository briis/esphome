...
WaveshareEPaper4P2In2bV2 = waveshare_epaper_ns.class_(
    "WaveshareEPaper4P2In2bV2", WaveshareEPaper
)
...
MODELS = {
    ...
    "4.20inb-bv2": ("b-alt", WaveshareEPaper4P2In2bV2),
